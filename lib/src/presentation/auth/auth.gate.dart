...
import '../layout/main_layout.dart';  // ✅ SCHIMBAT de la home_screen.dart
            ...
            child: Column(
              ...
              children: [
                ...
                TextFormField(
                  ...
                  enabled: !_continueAsGuest,
                  onFieldSubmitted: (_) => !_continueAsGuest ? _login() : null,
                    ...
                    Padding(
                      ...
                      child: Text(
                        ...
                        style: textTheme.bodyMedium?.copyWith(
                          color: const Color.fromARGB(255, 184, 178, 148),
                        ),
                      ),
                    ),
                    const Expanded(child: Divider(thickness: 1)),
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                      color: _continueAsGuest 
                        ? const Color.fromARGB(255, 185, 158, 88) 
                        : const Color.fromARGB(255, 165, 151, 102),
                      width: 1.5,
                    ),
                  ),
                ...
                if (_continueAsGuest)
                  Container(
                    padding: const EdgeInsets.all(16),
                    decoration: BoxDecoration(
                      color: const Color.fromARGB(255, 29, 30, 31).withOpacity(0.5),
                      borderRadius: BorderRadius.circular(12),
                    ),
                    child: Row(
                      children: [
